...
extern "C"
{
    ...
    const char*         UnityIPhoneRuntimeVersion = "5.3.2f1";
...
#define DLL_EXPORT
    ...
    DECL_USER_FUNC(soomlaCore_Init);
    DECL_USER_FUNC(keyValStorage_GetValue);
    DECL_USER_FUNC(keyValStorage_SetValue);
    DECL_USER_FUNC(keyValStorage_DeleteKeyValue);
    DECL_USER_FUNC(rewardStorage_GetLastGivenTimeMillis);
    DECL_USER_FUNC(rewardStorage_GetTimesGiven);
    DECL_USER_FUNC(rewardStorage_SetTimesGiven);
    DECL_USER_FUNC(rewardStorage_GetLastSeqIdxGiven);
    DECL_USER_FUNC(rewardStorage_SetLastSeqIdxGiven);
    DECL_USER_FUNC(soomlaStore_LoadBillingService);
    DECL_USER_FUNC(soomlaStore_BuyMarketItem);
    DECL_USER_FUNC(soomlaStore_RestoreTransactions);
    DECL_USER_FUNC(soomlaStore_RefreshInventory);
    DECL_USER_FUNC(soomlaStore_RefreshMarketItemsDetails);
    DECL_USER_FUNC(soomlaStore_TransactionsAlreadyRestored);
    DECL_USER_FUNC(soomlaStore_SetSSV);
    DECL_USER_FUNC(eventDispatcher_PushEventSoomlaStoreInitialized);
    DECL_USER_FUNC(eventDispatcher_PushEventUnexpectedStoreError);
    DECL_USER_FUNC(eventDispatcher_PushEventCurrencyBalanceChanged);
    DECL_USER_FUNC(eventDispatcher_PushEventGoodBalanceChanged);
    DECL_USER_FUNC(eventDispatcher_PushEventGoodEquipped);
    DECL_USER_FUNC(eventDispatcher_PushEventGoodUnEquipped);
    DECL_USER_FUNC(eventDispatcher_PushEventGoodUpgrade);
    DECL_USER_FUNC(eventDispatcher_PushEventItemPurchased);
    DECL_USER_FUNC(eventDispatcher_PushEventItemPurchaseStarted);
    DECL_USER_FUNC(storeInfo_SetStoreAssets);
    DECL_USER_FUNC(storeInfo_LoadFromDB);
    DECL_USER_FUNC(vcStorage_GetBalance);
    DECL_USER_FUNC(vcStorage_SetBalance);
    DECL_USER_FUNC(vcStorage_Add);
    DECL_USER_FUNC(vcStorage_Remove);
    DECL_USER_FUNC(vgStorage_RemoveUpgrades);
    DECL_USER_FUNC(vgStorage_AssignCurrentUpgrade);
    DECL_USER_FUNC(vgStorage_GetCurrentUpgrade);
    DECL_USER_FUNC(vgStorage_IsEquipped);
    DECL_USER_FUNC(vgStorage_Equip);
    DECL_USER_FUNC(vgStorage_UnEquip);
    DECL_USER_FUNC(vgStorage_GetBalance);
    DECL_USER_FUNC(vgStorage_SetBalance);
    DECL_USER_FUNC(vgStorage_Add);
    DECL_USER_FUNC(vgStorage_Remove);
    DECL_USER_FUNC(eventDispatcher_Init);
    DECL_USER_FUNC(_chartBoostInit);
    DECL_USER_FUNC(_chartBoostIsAnyViewVisible);
    DECL_USER_FUNC(_chartBoostCacheInterstitial);
    DECL_USER_FUNC(_chartBoostHasInterstitial);
    DECL_USER_FUNC(_chartBoostShowInterstitial);
    DECL_USER_FUNC(_chartBoostCacheRewardedVideo);
    DECL_USER_FUNC(_chartBoostHasRewardedVideo);
    DECL_USER_FUNC(_chartBoostShowRewardedVideo);
    DECL_USER_FUNC(_chartBoostCacheMoreApps);
    DECL_USER_FUNC(_chartBoostHasMoreApps);
    DECL_USER_FUNC(_chartBoostShowMoreApps);
    DECL_USER_FUNC(_chartBoostCacheInPlay);
    DECL_USER_FUNC(_chartBoostHasInPlay);
    DECL_USER_FUNC(_chartBoostGetInPlay);
    DECL_USER_FUNC(_chartBoostSetCustomId);
    DECL_USER_FUNC(_chartBoostDidPassAgeGate);
    DECL_USER_FUNC(_chartBoostGetCustomId);
    DECL_USER_FUNC(_chartBoostHandleOpenURL);
    DECL_USER_FUNC(_chartBoostSetShouldPauseClickForConfirmation);
    DECL_USER_FUNC(_chartBoostSetShouldRequestInterstitialsInFirstSession);
    DECL_USER_FUNC(_chartBoostShouldDisplayInterstitialCallbackResult);
    DECL_USER_FUNC(_chartBoostShouldDisplayRewardedVideoCallbackResult);
    DECL_USER_FUNC(_chartBoostShouldDisplayMoreAppsCallbackResult);
    DECL_USER_FUNC(_chartBoostGetAutoCacheAds);
    DECL_USER_FUNC(_chartBoostSetAutoCacheAds);
    DECL_USER_FUNC(_chartBoostSetShouldDisplayLoadingViewForMoreApps);
    DECL_USER_FUNC(_chartBoostSetShouldPrefetchVideoContent);
    DECL_USER_FUNC(_chartBoostTrackInAppPurchaseEvent);
    DECL_USER_FUNC(_chartBoostSetGameObjectName);
    DECL_USER_FUNC(_chartBoostSetStatusBarBehavior);
    DECL_USER_FUNC(_chartBoostTrackLevelInfo);
    DECL_USER_FUNC(_chartBoostInPlayClick);
    DECL_USER_FUNC(_chartBoostInPlayShow);
    DECL_USER_FUNC(_chartBoostInPlayGetAppIcon);
    DECL_USER_FUNC(_chartBoostInPlayGetAppIconSize);
    DECL_USER_FUNC(_chartBoostInPlayGetAppName);
    DECL_USER_FUNC(_chartBoostFreeInPlayObject);
    DECL_USER_FUNC(GADUCreateRequest);
    DECL_USER_FUNC(GADUAddTestDevice);
    DECL_USER_FUNC(GADUAddKeyword);
    DECL_USER_FUNC(GADUSetBirthday);
    DECL_USER_FUNC(GADUSetGender);
    DECL_USER_FUNC(GADUTagForChildDirectedTreatment);
    DECL_USER_FUNC(GADUSetExtra);
    DECL_USER_FUNC(GADUSetRequestAgent);
    DECL_USER_FUNC(GADURelease);
    DECL_USER_FUNC(GADUCreateBannerView);
    DECL_USER_FUNC(GADUCreateSmartBannerView);
    DECL_USER_FUNC(GADUSetBannerCallbacks);
    DECL_USER_FUNC(GADUHideBannerView);
    DECL_USER_FUNC(GADUShowBannerView);
    DECL_USER_FUNC(GADURemoveBannerView);
    DECL_USER_FUNC(GADURequestBannerAd);
    DECL_USER_FUNC(GADUCreateInterstitial);
    DECL_USER_FUNC(GADUSetInterstitialCallbacks);
    DECL_USER_FUNC(GADUInterstitialReady);
    DECL_USER_FUNC(GADUShowInterstitial);
    DECL_USER_FUNC(GADURequestInterstitial);
    DECL_USER_FUNC(GADUCreateRewardBasedVideoAd);
    DECL_USER_FUNC(GADURewardBasedVideoAdReady);
    DECL_USER_FUNC(GADUShowRewardBasedVideoAd);
    DECL_USER_FUNC(GADURequestRewardBasedVideoAd);
    DECL_USER_FUNC(GADUSetRewardBasedVideoAdCallbacks);
}
DLL_EXPORT void RegisterMonoModules()
{
    ...
    REGISTER_USER_FUNC(soomlaCore_Init);
    REGISTER_USER_FUNC(keyValStorage_GetValue);
    REGISTER_USER_FUNC(keyValStorage_SetValue);
    REGISTER_USER_FUNC(keyValStorage_DeleteKeyValue);
    REGISTER_USER_FUNC(rewardStorage_GetLastGivenTimeMillis);
    REGISTER_USER_FUNC(rewardStorage_GetTimesGiven);
    REGISTER_USER_FUNC(rewardStorage_SetTimesGiven);
    REGISTER_USER_FUNC(rewardStorage_GetLastSeqIdxGiven);
    REGISTER_USER_FUNC(rewardStorage_SetLastSeqIdxGiven);
    REGISTER_USER_FUNC(soomlaStore_LoadBillingService);
    REGISTER_USER_FUNC(soomlaStore_BuyMarketItem);
    REGISTER_USER_FUNC(soomlaStore_RestoreTransactions);
    REGISTER_USER_FUNC(soomlaStore_RefreshInventory);
    REGISTER_USER_FUNC(soomlaStore_RefreshMarketItemsDetails);
    REGISTER_USER_FUNC(soomlaStore_TransactionsAlreadyRestored);
    REGISTER_USER_FUNC(soomlaStore_SetSSV);
    REGISTER_USER_FUNC(eventDispatcher_PushEventSoomlaStoreInitialized);
    REGISTER_USER_FUNC(eventDispatcher_PushEventUnexpectedStoreError);
    REGISTER_USER_FUNC(eventDispatcher_PushEventCurrencyBalanceChanged);
    REGISTER_USER_FUNC(eventDispatcher_PushEventGoodBalanceChanged);
    REGISTER_USER_FUNC(eventDispatcher_PushEventGoodEquipped);
    REGISTER_USER_FUNC(eventDispatcher_PushEventGoodUnEquipped);
    REGISTER_USER_FUNC(eventDispatcher_PushEventGoodUpgrade);
    REGISTER_USER_FUNC(eventDispatcher_PushEventItemPurchased);
    REGISTER_USER_FUNC(eventDispatcher_PushEventItemPurchaseStarted);
    REGISTER_USER_FUNC(storeInfo_SetStoreAssets);
    REGISTER_USER_FUNC(storeInfo_LoadFromDB);
    REGISTER_USER_FUNC(vcStorage_GetBalance);
    REGISTER_USER_FUNC(vcStorage_SetBalance);
    REGISTER_USER_FUNC(vcStorage_Add);
    REGISTER_USER_FUNC(vcStorage_Remove);
    REGISTER_USER_FUNC(vgStorage_RemoveUpgrades);
    REGISTER_USER_FUNC(vgStorage_AssignCurrentUpgrade);
    REGISTER_USER_FUNC(vgStorage_GetCurrentUpgrade);
    REGISTER_USER_FUNC(vgStorage_IsEquipped);
    REGISTER_USER_FUNC(vgStorage_Equip);
    REGISTER_USER_FUNC(vgStorage_UnEquip);
    REGISTER_USER_FUNC(vgStorage_GetBalance);
    REGISTER_USER_FUNC(vgStorage_SetBalance);
    REGISTER_USER_FUNC(vgStorage_Add);
    REGISTER_USER_FUNC(vgStorage_Remove);
    REGISTER_USER_FUNC(eventDispatcher_Init);
    REGISTER_USER_FUNC(_chartBoostInit);
    REGISTER_USER_FUNC(_chartBoostIsAnyViewVisible);
    REGISTER_USER_FUNC(_chartBoostCacheInterstitial);
    REGISTER_USER_FUNC(_chartBoostHasInterstitial);
    REGISTER_USER_FUNC(_chartBoostShowInterstitial);
    REGISTER_USER_FUNC(_chartBoostCacheRewardedVideo);
    REGISTER_USER_FUNC(_chartBoostHasRewardedVideo);
    REGISTER_USER_FUNC(_chartBoostShowRewardedVideo);
    REGISTER_USER_FUNC(_chartBoostCacheMoreApps);
    REGISTER_USER_FUNC(_chartBoostHasMoreApps);
    REGISTER_USER_FUNC(_chartBoostShowMoreApps);
    REGISTER_USER_FUNC(_chartBoostCacheInPlay);
    REGISTER_USER_FUNC(_chartBoostHasInPlay);
    REGISTER_USER_FUNC(_chartBoostGetInPlay);
    REGISTER_USER_FUNC(_chartBoostSetCustomId);
    REGISTER_USER_FUNC(_chartBoostDidPassAgeGate);
    REGISTER_USER_FUNC(_chartBoostGetCustomId);
    REGISTER_USER_FUNC(_chartBoostHandleOpenURL);
    REGISTER_USER_FUNC(_chartBoostSetShouldPauseClickForConfirmation);
    REGISTER_USER_FUNC(_chartBoostSetShouldRequestInterstitialsInFirstSession);
    REGISTER_USER_FUNC(_chartBoostShouldDisplayInterstitialCallbackResult);
    REGISTER_USER_FUNC(_chartBoostShouldDisplayRewardedVideoCallbackResult);
    REGISTER_USER_FUNC(_chartBoostShouldDisplayMoreAppsCallbackResult);
    REGISTER_USER_FUNC(_chartBoostGetAutoCacheAds);
    REGISTER_USER_FUNC(_chartBoostSetAutoCacheAds);
    REGISTER_USER_FUNC(_chartBoostSetShouldDisplayLoadingViewForMoreApps);
    REGISTER_USER_FUNC(_chartBoostSetShouldPrefetchVideoContent);
    REGISTER_USER_FUNC(_chartBoostTrackInAppPurchaseEvent);
    REGISTER_USER_FUNC(_chartBoostSetGameObjectName);
    REGISTER_USER_FUNC(_chartBoostSetStatusBarBehavior);
    REGISTER_USER_FUNC(_chartBoostTrackLevelInfo);
    REGISTER_USER_FUNC(_chartBoostInPlayClick);
    REGISTER_USER_FUNC(_chartBoostInPlayShow);
    REGISTER_USER_FUNC(_chartBoostInPlayGetAppIcon);
    REGISTER_USER_FUNC(_chartBoostInPlayGetAppIconSize);
    REGISTER_USER_FUNC(_chartBoostInPlayGetAppName);
    REGISTER_USER_FUNC(_chartBoostFreeInPlayObject);
    REGISTER_USER_FUNC(GADUCreateRequest);
    REGISTER_USER_FUNC(GADUAddTestDevice);
    REGISTER_USER_FUNC(GADUAddKeyword);
    REGISTER_USER_FUNC(GADUSetBirthday);
    REGISTER_USER_FUNC(GADUSetGender);
    REGISTER_USER_FUNC(GADUTagForChildDirectedTreatment);
    REGISTER_USER_FUNC(GADUSetExtra);
    REGISTER_USER_FUNC(GADUSetRequestAgent);
    REGISTER_USER_FUNC(GADURelease);
    REGISTER_USER_FUNC(GADUCreateBannerView);
    REGISTER_USER_FUNC(GADUCreateSmartBannerView);
    REGISTER_USER_FUNC(GADUSetBannerCallbacks);
    REGISTER_USER_FUNC(GADUHideBannerView);
    REGISTER_USER_FUNC(GADUShowBannerView);
    REGISTER_USER_FUNC(GADURemoveBannerView);
    REGISTER_USER_FUNC(GADURequestBannerAd);
    REGISTER_USER_FUNC(GADUCreateInterstitial);
    REGISTER_USER_FUNC(GADUSetInterstitialCallbacks);
    REGISTER_USER_FUNC(GADUInterstitialReady);
    REGISTER_USER_FUNC(GADUShowInterstitial);
    REGISTER_USER_FUNC(GADURequestInterstitial);
    REGISTER_USER_FUNC(GADUCreateRewardBasedVideoAd);
    REGISTER_USER_FUNC(GADURewardBasedVideoAdReady);
    REGISTER_USER_FUNC(GADUShowRewardBasedVideoAd);
    REGISTER_USER_FUNC(GADURequestRewardBasedVideoAd);
    REGISTER_USER_FUNC(GADUSetRewardBasedVideoAdCallbacks);
}
